...
include "../core/app/model/ExpenseCategoryData.php";
...
$entradas = OperationDetailData::GetInputQYesF($product->id);
$disponibles = OperationDetailData::GetQYesF($product->id);
$salidas = -1*OperationDetailData::GetOutputQYesF($product->id);
