...
<body  onload='' class="<?php if (isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])) : ?> menu   sidebar-mini <?php else : ?>login-page<?php endif; ?>">
  ...
  <?php if ((isset($_SESSION["user_id"])) && ($_SESSION['typeUser'] == "su")) : ?>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="./?view=alumnos/index" style="color: white;">Temario</a></li>
    ...
    <li class="treeview">
        <a href="#"><i class="fa-solid fa-address-book"  style="color: white;"> </i> <span style="color: white;">Contacto</span></a>
    </li>
...
<?php endif; ?>
      ...
      <li class="treeview">
        ...
        <a href="#"><i class="fa-solid fa-address-book"  style="color: white;"></i> <span style="color: white;">Contacto</span></a>
         ...
         <li class="treeview">
         <a href="./?view=perfilUsuario/index"><i class="fa-solid fa-user" style="color: white;"></i> <span style="color: white;">Perfil</span></a>
      </li>
         <ul class="treeview-menu">
